...
STRINGS: dict[str, dict[str, str]] = {
    ...
    "upload_drop": {MY: "ဖိုင်ကို ဤနေရာသို့ ဆွဲထည့်ပါ", EN: "Drag and drop a file here"},
    "upload_limit": {MY: "ဖိုင်တစ်ခုလျှင် 50MB အထိ · PDF, ဓာတ်ပုံ, Excel, CSV",
                     EN: "Up to 50MB · PDF, image, Excel, CSV"},
    "upload_browse": {MY: "ဖိုင်ရွေးမည်", EN: "Browse files"},
